...
const DashboardPage = () => {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-8 px-4 sm:px-0">
      ...
      {/* ========================================== */}
      <section
        className="relative overflow-hidden rounded-3xl min-h-[150px] md:min-h-[210px] shadow-sm transition-all duration-300 hover:shadow-md"
        style={{
          backgroundImage: `
      ...
      >
        ...
        <div className="relative z-10 min-h-[150px] md:min-h-[210px] p-4 sm:p-8 flex flex-col justify-between">
