...
import { Calendar, Clock, User, AlertCircle, Users, UserCircle } from 'lucide-react';
...
export const VisitModalContent = ({
  ...
  useEffect(() => {
    if (visit && mode === 'edit') {
      ...
      setTargetType(patients.length === 0 ? 'personal' : 'personal');
    }
